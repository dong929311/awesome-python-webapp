...
class Response(object):
    ...
    def set_cookie(self, name, value, max_age=None, expires=None, path='/', domain=None, secure=None,http_only=True):
        if not hasattr(self, '_cookies'):
            self._cookies = {}
